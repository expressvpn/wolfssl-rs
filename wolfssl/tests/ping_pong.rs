...
#[test_case(Protocol::DtlsClientV1_2, Protocol::DtlsServerV1_3, ProtocolVersion::Unknown => panics; "client_1.2_server_1.3")]
#[test_case(Protocol::DtlsClientV1_2, Protocol::DtlsServerV1_2, ProtocolVersion::DtlsV1_2; "client_1.2_server_1.2")]
#[test_case(Protocol::DtlsClientV1_2, Protocol::DtlsServer, ProtocolVersion::DtlsV1_2; "client_1.2_server")]
#[test_case(Protocol::DtlsClientV1_3, Protocol::DtlsServerV1_3, ProtocolVersion::DtlsV1_3; "client_1.3_server_1.3")]
#[test_case(Protocol::DtlsClientV1_3, Protocol::DtlsServerV1_2, ProtocolVersion::Unknown => panics; "client_1.3_server_1.2")]
#[test_case(Protocol::DtlsClientV1_3, Protocol::DtlsServer, ProtocolVersion::DtlsV1_3; "client_1.3_server")]
#[test_case(Protocol::DtlsClient, Protocol::DtlsServerV1_3, ProtocolVersion::DtlsV1_3; "client_server_1.3")]
// TODO: WolfSSL downgrade bug
// #[test_case(Protocol::DtlsClient, Protocol::DtlsServerV1_2; "client_server_1.2")]
#[test_case(Protocol::DtlsClient, Protocol::DtlsServer, ProtocolVersion::DtlsV1_3; "client_server")]
#[tokio::test]
async fn dtls(
...
#[test_case(Protocol::TlsClientV1_2, Protocol::TlsServerV1_3, ProtocolVersion::Unknown => panics; "client_1.2_server_1.3")]
#[test_case(Protocol::TlsClientV1_2, Protocol::TlsServerV1_2, ProtocolVersion::TlsV1_2; "client_1.2_server_1.2")]
#[test_case(Protocol::TlsClientV1_2, Protocol::TlsServer, ProtocolVersion::TlsV1_2; "client_1.2_server")]
#[test_case(Protocol::TlsClientV1_3, Protocol::TlsServerV1_3, ProtocolVersion::TlsV1_3; "client_1.3_server_1.3")]
#[test_case(Protocol::TlsClientV1_3, Protocol::TlsServerV1_2, ProtocolVersion::Unknown => panics; "client_1.3_server_1.2")]
#[test_case(Protocol::TlsClientV1_3, Protocol::TlsServer, ProtocolVersion::TlsV1_3; "client_1.3_server")]
#[test_case(Protocol::TlsClient, Protocol::TlsServerV1_3, ProtocolVersion::TlsV1_3; "client_server_1.3")]
#[test_case(Protocol::TlsClient, Protocol::TlsServerV1_2, ProtocolVersion::TlsV1_2; "client_server_1.2")]
#[test_case(Protocol::TlsClient, Protocol::TlsServer, ProtocolVersion::TlsV1_3; "client_server")]
#[tokio::test]
async fn tls(
    client_protocol: Protocol,
    server_protocol: Protocol,
