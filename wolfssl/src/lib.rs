...
impl CurveGroup {
    fn as_ffi(&self) -> std::os::raw::c_uint {
        ...
        match self {
            ...
            #[cfg(feature = "postquantum")]
            P256MLKEMLevel1 => wolfssl_sys::WOLFSSL_P256_ML_KEM_512,
            #[cfg(feature = "postquantum")]
            P384MLKEMLevel3 => wolfssl_sys::WOLFSSL_P384_ML_KEM_768,
            #[cfg(feature = "postquantum")]
            P521MLKEMLevel5 => wolfssl_sys::WOLFSSL_P521_ML_KEM_1024,
        }
    }
}
